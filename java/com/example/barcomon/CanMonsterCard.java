...
public class CanMonsterCard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_can_monster_card);
        ...
        LevelTextView=(TextView)findViewById(R.id.CanMonsterCardLevelTextView);
        AttackTextView=(TextView)findViewById(R.id.CanMonsterCardAttackTextView);
        DefenseTextView=(TextView)findViewById(R.id.CanMonsterCardDefenseTextView);
        LoveLevelTextView=(TextView)findViewById(R.id.CanMonsterCardLoveLevelTextView);
        StrengthTextView=(TextView)findViewById(R.id.CanMonsterCardStrength);
