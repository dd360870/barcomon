...
/*
    ...
    private void playBGM(){
        MonsterBoxPlayer = MediaPlayer.create(this, R.raw.battle_set_bgm);
        MonsterBoxPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);
        MonsterBoxPlayer.setLooping(true);
        MonsterBoxPlayer.start();
    }
